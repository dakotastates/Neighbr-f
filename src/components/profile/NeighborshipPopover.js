...
export default function NeighborshipPopover(props) {
  ...
  return (
    <div>
      ...
      >
        <Typography className={classes.typography}><NeighborshipsContainer selectedUser={props.selectedUser} /></Typography>
      </Popover>
    </div>
  );
}
